...
import dev.hoangcuong.imagepicker.model.SavePath;
import dev.hoangcuong.imagepicker.ui.imagepicker.ImagePicker;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void launchFragment() {
        ...
        config.setDoneTitle(getString(dev.hoangcuong.imagepicker.R.string.imagepicker_action_done));
        config.setFolderTitle(getString(dev.hoangcuong.imagepicker.R.string.imagepicker_title_folder));
        config.setImageTitle(getString(dev.hoangcuong.imagepicker.R.string.imagepicker_title_image));
