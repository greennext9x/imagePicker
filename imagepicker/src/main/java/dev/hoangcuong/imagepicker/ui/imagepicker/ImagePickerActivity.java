...
import dev.hoangcuong.imagepicker.FragmentZoomImagePicker;
import dev.hoangcuong.imagepicker.R;
import dev.hoangcuong.imagepicker.SendImage;
import dev.hoangcuong.imagepicker.helper.CameraHelper;
import dev.hoangcuong.imagepicker.helper.LogHelper;
import dev.hoangcuong.imagepicker.helper.PermissionHelper;
...
import dev.hoangcuong.imagepicker.widget.ImagePickerToolbar;
import dev.hoangcuong.imagepicker.widget.ProgressWheel;
import dev.hoangcuong.imagepicker.widget.SnackBarView;
import java.util.ArrayList;
import java.util.List;


public class ImagePickerActivity extends AppCompatActivity implements ImagePickerView,SendImage {
    ...
    @Override
    public void onSendImage(String path) {
        Bundle bundle = new Bundle();
        bundle.putString("path",path);
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        FragmentZoomImagePicker newFragment = FragmentZoomImagePicker.newInstance();
